  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image',       content: 'https://ramadan-quiz-six.vercel.app/og-image-2.png' },
        { property: 'og:image:width',  content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:type',        content: 'website' },
        { property: 'og:url',         content: 'https://ramadan-quiz-six.vercel.app' },

        { name: 'twitter:card',  content: 'summary_large_image' },
        { name: 'twitter:image', content: 'https://ramadan-quiz-six.vercel.app/og-image-2.png' },
      ],
    },
  },
})
